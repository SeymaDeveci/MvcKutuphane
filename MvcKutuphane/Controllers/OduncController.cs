...
namespace MvcKutuphane.Controllers
{
    public class OduncController : Controller
    {
        ...
        [Authorize(Roles ="A")] // sadece A yetkili adminler görür 
        ...
        {
            List<SelectListItem> deger1 = (from x in db.TBLUYELER.ToList() //List seklinde değeri alıp drop down liste atıyoruz html tarafında
        ...
        public ActionResult OduncVer(TBLHAREKET p)
        {
            ...
            p.TBLUYELER = d1; //Navigation Property ile değer atama
            p.TBLKITAP = d2;
            p.TBLPERSONEL = d3;
            db.TBLHAREKET.Add(p);
            db.SaveChanges();
        ...
        public ActionResult OduncIade(TBLHAREKET p)
        {
            ...
            DateTime d1 = DateTime.Parse(odn.IADETARIH.ToString()); //kitabın iade tarihini datetime a dönüştür
            DateTime d2 = Convert.ToDateTime(DateTime.Now.ToShortDateString());
            TimeSpan d3 = d2 - d1; // iki tarih arası fark
