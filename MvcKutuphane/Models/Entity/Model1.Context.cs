...
namespace MvcKutuphane.Models.Entity
{
    ...
    public partial class DBKUTUPHANEEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> BugünküEmanetler()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("BugünküEmanetler");
        }
    }
}
